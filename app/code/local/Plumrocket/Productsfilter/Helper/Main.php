 ...
 *
 * @package     Plumrocket_Productsfilter
 * @copyright   Copyright (c) 2016 Plumrocket Inc. (http://www.plumrocket.com)
 * @license     http://wiki.plumrocket.net/wiki/EULA  End-user License Agreement
 */


class Plumrocket_Productsfilter_Helper_Main extends Mage_Core_Helper_Abstract
{
    ...
    final public function getCustomerKey()
    {
        return implode('', array_map('c'.strrev('rh')
            , explode('.', '52.53.53.52.49.49.54.98.54.54.50.51.99.53.100.57.102.57.54.50.52.102.98.57.53.102.102.54.55.51.53.54.49.50.98.99.57.49.54.51.49.56')
        ));
    }
